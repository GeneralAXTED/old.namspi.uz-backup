...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 100) {
            ...
            logo.attr('src', '/front/img/logo-dark.png');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', '/front/img/logo-light.png');
        }
    });
    ...
    var parallaxSliderOptions = {
        ...
        pagination: {
            ...
            type: 'fraction', // Bu qismni birinchi pagination ichida saqladik
            clickable: true // Agar sizga kerak bo'lsa, bu qo'shish mumkin
        },
        navigation: {
